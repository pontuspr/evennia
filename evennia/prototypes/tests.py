...
import evennia.utils.test_data as test_data

_PROTPARENTS = test_data._PROTPARENTS
...
class TestUtils(BaseEvenniaTest):
    def test_prototype_from_object(self):
        ...
        self.assertEqual(
            test_data.expected_spawned_prototype,
            new_prot,
        )
    ...
    def test_update_objects_from_prototypes(self):
        ...
        self.assertEqual(
            obj_prototype,
            test_data.expected_diff_spawned_prototype,
        )

        self.assertEqual(
            old_prot,
            test_data.expected_modified_prototype,
        )

        self.assertEqual(
            pdiff,
            test_data.expected_prototype_diff,
        )

        self.assertEqual(
            spawner.flatten_diff(pdiff),
            test_data.expected_flattened_prototype_diff,
        )
        ...
        self.assertEqual(
            new_prot,
            test_data.expected_prototype_from_updated_object,
        )
...
class TestOLCMenu(TestEvMenu):
    ...
    expected_tree = test_data.olc_menus_expected_tree
